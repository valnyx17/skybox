...
local opts = {
  ...
  opt = {
    ...
    wildoptions = opt.wildoptions + "fuzzy",
    whichwrap = opt.whichwrap + "<,>,h,l,[,],b,s",
    diffopt = {
      -- :h 'diffopt'
      "vertical",
      "iwhite",
...
if vim.fn.executable("rg") then
  opts.opt.grepprg = "rg --vimgrep --smart-case --follow"
  opts.opt.grepformat = "%f:%l:%c:%m"
end

for scope, ops in pairs(opts) do
