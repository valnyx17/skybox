  ...
  opts = function()
    ...
    function ret.on_attach(client, bufnr)
      ...
      if client.supports_method(methods.textDocument_definition) then
        nmap("gd", "<cmd>FzfLua lsp_definitions jump_to_single_result=true ignore_current_line=true<CR>", { desc = "[g]oto [d]efinition" })
      end

      if client.supports_method(methods.textDocument_references) then
        nmap("gr", "<cmd>FzfLua lsp_references jump_to_single_result=true ignore_current_line=true<CR>", { desc = "[g]oto [r]eference" })
      end

      if client.supports_method(methods.textDocument_implementation) then
        nmap("gI", "<cmd>FzfLua lsp_implementations jump_to_single_result=true ignore_current_line=true<CR>", { desc = "[g]oto [i]mplentation" })
      end
      ...
      if client.supports_method(methods.textDocument_declaration) then
        nmap("gD", "<cmd>FzfLua lsp_declarations jump_to_single_result=true ignore_current_line=true<CR>", { desc = "[g]oto [D]eclaration" })
      end
